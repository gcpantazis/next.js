...
class Messenger {
  ...
  ensureInitialized () {
    ...
    navigator.serviceWorker.register(`/${__NEXT_DATA__.nextAssetDirectory}/_next-prefetcher.js`)
...
function getPrefetchUrl (href) {
  ...
  const url = `/${__NEXT_DATA__.nextAssetDirectory}/${__NEXT_DATA__.buildId}/${__NEXT_DATA__.pagesDirectory}${pathname}`
